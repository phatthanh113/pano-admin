...
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->widgets([
                \App\Filament\Widgets\PanoStatsWidget::class,
            ...
            ->renderHook('panels::topbar.end', fn () => Blade::render('<x-lang-switcher class="ml-4" />'))
            ->renderHook('panels::auth.login.form.after', fn () => Blade::render('<div class="mt-6 flex justify-center"><x-lang-switcher /></div>'));
    }
}
